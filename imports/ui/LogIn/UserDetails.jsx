		...
		return (
			...
			<img className="profile" src={"data:image/jpeg;base64," + this.props.userState.ProfileBase64}/>
				<div> 
					...
					<button className="editButton" onClick={this.handleEditNameClick}>Edit</button>
					...
					</select> } <button className="editButton" onClick={this.handleEditTeamClick}>Edit</button>     
