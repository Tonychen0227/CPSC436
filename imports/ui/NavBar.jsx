      ...
      <Navbar bg="light" expand="lg">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mr-auto">
            <Nav.Link onClick={() => this.handleClick(1)}>Home</Nav.Link>
            <Nav.Link onClick={() => this.handleClick(2)}>Stats</Nav.Link>
            <Nav.Link onClick={() => this.handleClick(3)}>Log in</Nav.Link>
            <Nav.Link onClick={() => this.handleClick(69420)}>About GGPanda</Nav.Link>
          </Nav>
        </Navbar.Collapse>
      </Navbar>
      </div>
